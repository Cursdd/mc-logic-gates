...
execute if score $uiSizeY lg.TEMP matches 25.. positioned ~ ~6.25 ~ run function lg:spawn_ui/0/for_hitbox/y/loop with storage lg:temp

#If 0 > ui size < 25 loop with the remainder
execute unless score $uiSizeY lg.TEMP matches 25.. if score $uiSizeY lg.TEMP matches 1.. run function lg:spawn_ui/0/for_hitbox/y/store_values