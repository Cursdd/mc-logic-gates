...
#Debug
tellraw @a [{"color":"gold","text":"====================================\n"},{"color":"green","text":"Found Input: Gate Output"}]

tag @s add lg.input
tag @e[tag=!lg.input] remove lg.searched

execute positioned ^0.25 ^ ^ as @n[tag=!lg.gate_input,predicate=lg:rod_outputs/etw,distance=..0.001] at @s run function lg:bfs/find_output/get_type
...
execute positioned ^-0.25 ^ ^ as @n[tag=!lg.gate_input,predicate=lg:rod_outputs/wte,distance=..0.001] at @s run function lg:bfs/find_output/get_type
...
execute positioned ^ ^0.25 ^ as @n[tag=!lg.gate_input,predicate=lg:rod_outputs/stn,distance=..0.001] at @s run function lg:bfs/find_output/get_type
...
execute positioned ^ ^-0.25 ^ as @n[tag=!lg.gate_input,predicate=lg:rod_outputs/nts,distance=..0.001] at @s run function lg:bfs/find_output/get_type
